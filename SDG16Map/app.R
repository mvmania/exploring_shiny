...
SDGdf <- SDG[1:4112,] %>%
        mutate(Level = ifelse(Province == "All Indonesia", # Generate a column to distinguish national and provincial data
                              "National", 
                              "Provincial"))%>%
        filter(Level == "Provincial", SDG.Goal == 16)
...
ui <- navbarPage(theme = "bootstrap.css",
                 ...
                 sidebarLayout(
                         ...
                         sidebarPanel(
                                 ...
                                 shiny::a(h4("Download GOAL 16- PDF", 
                                             ...
                                             border-color: #f2f2f2"),
                                          target = "_blank",
                                          href = paste0("http://www.sdg4children.or.id/wp-content/uploads/2017/10/Goal-16.pdf
                                                        "))
                                          ),
